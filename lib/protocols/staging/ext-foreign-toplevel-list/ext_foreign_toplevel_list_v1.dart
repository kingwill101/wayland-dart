...
var offset = 0;
final toplevel = innerContext.getProxy(ByteData.view(data.buffer).getUint32(offset, Endian.little)).objectId;
offset += 4;
...
var offset = 0;
final titleLength = ByteData.view(data.buffer).getUint32(offset, Endian.little);
offset += 4;
final title = utf8.decode(data.sublist(offset, offset + titleLength - 1));
offset += titleLength; // Skip the string bytes and null terminator
...
var offset = 0;
final appIdLength = ByteData.view(data.buffer).getUint32(offset, Endian.little);
offset += 4;
final appId = utf8.decode(data.sublist(offset, offset + appIdLength - 1));
offset += appIdLength; // Skip the string bytes and null terminator
while (offset % 4 != 0) { offset++; } // Padding
...
var offset = 0;
final identifierLength = ByteData.view(data.buffer).getUint32(offset, Endian.little);
offset += 4;
final identifier = utf8.decode(data.sublist(offset, offset + identifierLength - 1));
offset += identifierLength; // Skip the string bytes and null terminator
while (offset % 4 != 0) { offset++; } // Padding
