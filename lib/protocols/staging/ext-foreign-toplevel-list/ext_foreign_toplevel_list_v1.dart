...
typedef ExtForeignToplevelListV1ToplevelEventHandler = void Function(
    ExtForeignToplevelListV1ToplevelEvent);
...
typedef ExtForeignToplevelListV1FinishedEventHandler = void Function(
    ExtForeignToplevelListV1FinishedEvent);
...
class ExtForeignToplevelListV1 extends Proxy implements Dispatcher {
  ...
  ExtForeignToplevelListV1(this.innerContext)
...
typedef ExtForeignToplevelHandleV1ClosedEventHandler = void Function(
    ExtForeignToplevelHandleV1ClosedEvent);
...
typedef ExtForeignToplevelHandleV1DoneEventHandler = void Function(
    ExtForeignToplevelHandleV1DoneEvent);
...
typedef ExtForeignToplevelHandleV1TitleEventHandler = void Function(
    ExtForeignToplevelHandleV1TitleEvent);
...
typedef ExtForeignToplevelHandleV1AppIdEventHandler = void Function(
    ExtForeignToplevelHandleV1AppIdEvent);
...
typedef ExtForeignToplevelHandleV1IdentifierEventHandler = void Function(
    ExtForeignToplevelHandleV1IdentifierEvent);
...
class ExtForeignToplevelHandleV1 extends Proxy implements Dispatcher {
  ...
  ExtForeignToplevelHandleV1(this.innerContext)
      : super(innerContext.allocateClientId()) {
    innerContext.register(this);
  }
    ...
    switch (opcode) {
      ...
      case 2:
        if (_titleHandler != null) {
          ...
          offset += 4;
          final title =
              utf8.decode(data.sublist(offset, offset + titleLength - 1));
      ...
      case 3:
        if (_appIdHandler != null) {
          ...
          offset += 4;
          final appId =
              utf8.decode(data.sublist(offset, offset + appIdLength - 1));
      ...
      case 4:
        if (_identifierHandler != null) {
          var offset = 0;
          final identifierLength =
              ByteData.view(data.buffer).getUint32(offset, Endian.little);
          offset += 4;
          final identifier =
              utf8.decode(data.sublist(offset, offset + identifierLength - 1));
          offset +=
              identifierLength; // Skip the string bytes and null terminator
          while (offset % 4 != 0) {
            offset++;
          } // Padding
