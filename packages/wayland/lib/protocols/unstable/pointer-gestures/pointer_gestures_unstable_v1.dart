...
/// [id]:
/// [pointer]:
  Result<ZwpPointerGestureSwipeV1,Object> getSwipeGesture(WlPointer pointer) {
...
/// [id]:
/// [pointer]:
  Result<ZwpPointerGesturePinchV1,Object> getPinchGesture(WlPointer pointer) {
...
/// [id]:
/// [pointer]:
  Result<ZwpPointerGestureHoldV1,Object> getHoldGesture(WlPointer pointer) {
...
_offset += 4;
final fingers = ByteData.view(data.buffer).getUint32(_offset, Endian.little);
_offset += 4;
...
final time = ByteData.view(data.buffer).getUint32(_offset, Endian.little);
_offset += 4;
final dx = fixedToDouble(ByteData.view(data.buffer).getInt32(_offset, Endian.little));
_offset += 4;
final dy = fixedToDouble(ByteData.view(data.buffer).getInt32(_offset, Endian.little));
_offset += 4;
...
final time = ByteData.view(data.buffer).getUint32(_offset, Endian.little);
_offset += 4;
final cancelled = ByteData.view(data.buffer).getInt32(_offset, Endian.little);
_offset += 4;
...
_offset += 4;
final rotation = fixedToDouble(ByteData.view(data.buffer).getInt32(_offset, Endian.little));
_offset += 4;
