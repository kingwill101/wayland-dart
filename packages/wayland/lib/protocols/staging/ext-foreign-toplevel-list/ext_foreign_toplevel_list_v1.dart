...
@override
toString(){
return "ExtForeignToplevelListV1ToplevelEvent (toplevel: $toplevel)";
}
}
...
class ExtForeignToplevelListV1 extends Proxy implements Dispatcher{
  ...
  ExtForeignToplevelListV1(this.innerContext) : super(innerContext.allocateClientId()){
...
@override
toString(){
return "ExtForeignToplevelListV1 {name: 'ext_foreign_toplevel_list_v1', id: '$objectId', version: '1',}";
}
...
/// 
  Result<void,Object> stop() {
    logLn("ExtForeignToplevelListV1::stop ");
...
bytesBuilder.add(Uint32List.fromList([objectId, (calclulatedSize << 16) | 0]).buffer.asUint8List());
    ...
    innerContext.sendMessage(bytesBuilder.toBytes(), );
      ...
      logLn("Exception in ExtForeignToplevelListV1::stop: $e");
   return Failure(e);
    }
...
innerContext.unRegister(this);
    logLn("ExtForeignToplevelListV1::destroy ");
var arguments = [];var argTypes = <WaylandType>[];
var calclulatedSize  = calculateSize(argTypes, arguments);
final bytesBuilder = BytesBuilder();
bytesBuilder.add(Uint32List.fromList([objectId, (calclulatedSize << 16) | 1]).buffer.asUint8List());
    ...
    innerContext.sendMessage(bytesBuilder.toBytes(), );
      ...
      logLn("Exception in ExtForeignToplevelListV1::destroy: $e");
   return Failure(e);
    }
    return Success(Object());
  }
...
logLn("ExtForeignToplevelListV1.dispatch($opcode, $fd, $data)");
...
toplevel,
     ...
     case 1:
       ...
       if (_finishedHandler != null) {
         _finishedHandler!(ExtForeignToplevelListV1FinishedEvent());
       }
       break;
   }
 }
...
@override
toString(){
return "ExtForeignToplevelHandleV1TitleEvent (title: $title)";
}
}
...
@override
toString(){
return "ExtForeignToplevelHandleV1AppIdEvent (appId: $appId)";
}
}
...
@override
toString(){
return "ExtForeignToplevelHandleV1IdentifierEvent (identifier: $identifier)";
}
}
...
class ExtForeignToplevelHandleV1 extends Proxy implements Dispatcher{
  ...
  ExtForeignToplevelHandleV1(this.innerContext) : super(innerContext.allocateClientId()){
    innerContext.register(this);
  }
...
@override
toString(){
return "ExtForeignToplevelHandleV1 {name: 'ext_foreign_toplevel_handle_v1', id: '$objectId', version: '1',}";
}
...
/// 
  Result<void,Object> destroy() {
innerContext.unRegister(this);
    logLn("ExtForeignToplevelHandleV1::destroy ");
var arguments = [];var argTypes = <WaylandType>[];
var calclulatedSize  = calculateSize(argTypes, arguments);
final bytesBuilder = BytesBuilder();
bytesBuilder.add(Uint32List.fromList([objectId, (calclulatedSize << 16) | 0]).buffer.asUint8List());
    ...
    innerContext.sendMessage(bytesBuilder.toBytes(), );
      ...
      logLn("Exception in ExtForeignToplevelHandleV1::destroy: $e");
   return Failure(e);
    }
    return Success(Object());
  }
...
/// - [identifier]:
 ...
 @override
 void dispatch(int opcode, int fd, Uint8List data) {
logLn("ExtForeignToplevelHandleV1.dispatch($opcode, $fd, $data)");
   switch (opcode) {     case 0:

       if (_closedHandler != null) {
         _closedHandler!(ExtForeignToplevelHandleV1ClosedEvent());
       }
       break;
     case 1:

       if (_doneHandler != null) {
         _doneHandler!(ExtForeignToplevelHandleV1DoneEvent());
       }
       break;
     case 2:
...
var _offset = 0;
final identifierLength = ByteData.view(data.buffer).getUint32(_offset, Endian.little);
_offset += 4;
final identifier = utf8.decode(data.sublist(_offset, _offset + identifierLength - 1));
_offset += identifierLength; // Skip the string bytes and null terminator
while (_offset % 4 != 0) { _offset++; } // Padding
